...
static void chassis_engineer_follow_chassis_yaw_control(fp32 *vx_set, fp32 *vy_set, fp32 *angle_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    *angle_set = (swing_angle-0.59);//大步兵角度
...
extern int xtl_change;
int xtl_time;
float changing_speed_function;
RC_ctrl_t *xtl_RC;
extern uint8_t flying_flag;
...
//		}
	  chassis_rc_to_control_vector(vx_set, vy_set, chassis_move_rc_to_vector);
		 *wz_set = -((float)(5 + 0.7 * get_robot_level()+ 1.0 * faster))*xtl_change;
		//控制底盘前后左右
//		if(flying_flag == 1)
//		{
//		  if(xtl_RC->rc.ch[4] == 660)
//	   	{
//		    *wz_set = -((float)(8.0 + 0.7 * get_robot_level()));
//		  }
//		  else if(xtl_RC->rc.ch[4] == -660)
//		  {
//			  *wz_set = ((float)(10.0 + 0.7 * get_robot_level()));
//		  }
//		  else
//		  {
//			  *wz_set = -((float)(10.0 + 0.7 * get_robot_level()));//联盟赛8
//		  }
//	  }
//		else if(flying_flag == 0)
//		{
//			if(xtl_RC->rc.ch[4] == 660)
//	   	{
//		    *wz_set = -((float)(6.5 + 0.7 *  get_robot_level()));
//		  }
//		  else if(xtl_RC->rc.ch[4] == -660)
//		  {
//			  *wz_set = ((float)(7.8 + 0.7 * get_robot_level()));//联盟6.5
//		  }
//		  else
//		  {
//			  *wz_set = -((float)(7.8 + 0.7 * get_robot_level()));
//		  }
//		}
