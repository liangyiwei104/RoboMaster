...
{
	  SendVisionData_Init();
	  gimbal_control.gimbal_yaw_motor.offset_ecd = 5580; //大步兵为4830 小步兵6830
		gimbal_control.gimbal_pitch_motor.offset_ecd =5725;//大步兵为3550 小步兵2550
		
		gimbal_control.gimbal_yaw_motor.min_relative_angle = -3.14;
		gimbal_control.gimbal_yaw_motor.max_relative_angle = 3.14;
	
		gimbal_control.gimbal_pitch_motor.min_relative_angle = -0.35;
		gimbal_control.gimbal_pitch_motor.max_relative_angle = 0.45;
    ...
    while (1)
    {
			...
			gimbal_control.gimbal_yaw_motor.offset_ecd =5580; //大步兵为4830 小步兵为6830
	    	gimbal_control.gimbal_pitch_motor.offset_ecd =5725;//大步兵为3550 小步兵2550
