...
//底盘运动过程最大前进速度++++++++++
#define NORMAL_MAX_CHASSIS_SPEED_X 3.5f //2.6//2
//chassis left or right max speed
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 4.0f  //2
...
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 30.0f//40//22.0f//30
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f//4
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 2.0f//0
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 9.0f//9
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 0.1f//0.2
